    ...
    <div className="bg-white text-gray-900">
      ...
      <section id="experience" className="py-20 px-4 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold mb-12 text-center">Educational Information</h2>
            ...
            {PORTFOLIO_DATA.experience.map((exp, index) => (
              <div key={index} className="bg-white p-6 rounded-lg border-l-4 border-blue-600 hover:shadow-md transition-all duration-300">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-500">{exp.academicyear}</span>
                </div>
                <p className="text-blue-600 font-medium mb-2">{exp.branch}</p>
                <p className="text-gray-600">{exp.percentage}</p>
              </div>
            ))}
          </div>
        </div>
